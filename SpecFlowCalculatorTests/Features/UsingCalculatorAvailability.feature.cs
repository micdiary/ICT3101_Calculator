...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("200", "30", "230", null)]
        [NUnit.Framework.TestCaseAttribute("-300", "40", "\"Cannot have negative number\"", null)]
...
#line hidden
#line 9
        testRunner.Then(string.Format("the availability result should be {0}", mTBF), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
        ...
        [NUnit.Framework.CategoryAttribute("Availability")]
        [NUnit.Framework.TestCaseAttribute("200", "400", "0.5", null)]
        [NUnit.Framework.TestCaseAttribute("300", "200", "\"MTTF cannot be lower than MTBF\"", null)]
